...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $purgeQuestion = new ConfirmationQuestion('This will delete all previous skills based on filters. Are you sure, you want to continue this action.?', false);
        ...
        $output->writeln(PHP_EOL.'<info>Total skills Scrapped </info>');
    }
}